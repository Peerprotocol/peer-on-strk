...
const Liquidation = () => {
    ...
    return (
        <div className="border border-gray-200 rounded-[1rem] flex flex-col md:flex-row justify-between gap-6 md:p-6 p-2 bg-white w-[95%] mx-auto mb-8">
            <div className="border border-gray-200 p-6 rounded-xl bg-[#efefef] relative flex flex-col justify-center w-full lg:w-[calc(48%-1rem)] h-[160px]">
            ...
            <div className="border border-gray-200 p-6 rounded-xl bg-[#efefef] relative flex flex-row items-center justify-between gap-8 w-full lg:w-[calc(53%-1rem)] min-h-[160px]">
