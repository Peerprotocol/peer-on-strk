...
const Dashboard: React.FC<TokenInfo> = ({ tokenReserved }) => {
  ...
  const MetricCard = ({ label, value }: { label: string; value: string }) => (
    <div className="relative bg-[#efefef] flex flex-col justify-center w-full h-[150px] rounded-2xl pl-4 lg:pl-6">
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-4 lg:gap-8 w-full md:justify-between">
        ...
        <div className="bg-white rounded-[20px] w-[402px] h-[412px] p-4">
          ...
          <hr />
          <br />
          <div className="w-[368px] h-[239px] rounded-[10px] bg-[#efefef] p-3">
